...
const elements = [
  ...
  {
    label:
      "HTML5, React, React Native, Vue, NEXT ,Tailwind, SASS, Bootstrap, MUI, PWA-SPA, Redux",
    value: "DESAROLLADOR",
  },
  {
  ...
  {
    label:
      "Web services, Postman, OpenIA API, Firebase, Auth0, Netlify, Fly.io, Vercel, Gitpages ",
    value: "CONSULTOR",
  },
];
      ...
      >
        ...
        <section id="inicio" className="inicio" style={{ marginTop: "30px" }}>
          <div className="contenido-banner">
            ...
            <a href="#">
              ...
              <a
                href="https://api.whatsapp.com/send?phone=3113913306"
                target="_blank"
        ...
        <section id="sobremi" className="sobremi">
          <div className="contenido-seccion">
            ...
            >
              <span>¡Saludos! Soy Carlos Zambrano</span>, un apasionado egresado
              de la carrera de sistemas del Instituto Tecnológico.{" "}
            </p>
            <p
              style={{
                fontSize: isMobile ? "18px" : "22px",
            ...
            >
              ...
              relacionado con la informática. Con más de{" "}
              <span>3 años de experiencia en el desarrollo Full Stack </span>,
              estoy constantemente explorando y expandiendo mis habilidades en
              el mundo digital.
            </p>
            <br />
            <div
            ...
            <div style={{ display: "flex" }}>
              ...
              <button
                onClick={handleButtonVerCertificado}
            ...
            >
              <div className="col izquierda">
                ...
                <div className="item izq">
                  ...
                  <div>
                    <p>
                      Curso de materias para el desarrollo ágil de aplicaciones
                      web/móviles:
                    </p>
                ...
                <div className="item izq">
                  ...
                  <p>
                    Ingeniería a nivel licenciatura en la carrera de Sistemas
                    Computacionales con especialidad en desarrollo ágil de
                    aplicaciones
                  </p>
                  <div className="conectori">
                    <div className="circuloi"></div>
                ...
                <div className="item izq">
                  ...
                  <p>
                    Estudio de la carrera de informarica a nivel bachilleraro
                    (educación media superior) en el instituto CONALEP de Tepic.
                  </p>
                  <div className="conectori">
                    <div className="circuloi"></div>
                  </div>
              ...
              <div className="col derecha">
                ...
                <div className="item der">
                  ...
                  <p>
                    Encargado de crear y desarrollar proyectos para nuestros
                    clientes, desde landin pages y tiendas online hasta
                    aplicaciones con un propósito específico.
                  </p>
                  <Box sx={{ ml: 5 }}>
                    <ul>
                ...
                <div className="item der">
                  ...
                  <p>
                    Desarrollé una Aplicación Web desde cero para optimizar y
                    agilizar el proceso de contratos físicos y entrega de
                    enfriadores, transformándolo en un flujo de trabajo
                  ...
                  <Box sx={{ ml: 5 }}>
                    <ul>
                      ...
                      <li>
                        Diseñar y construir componentes y servicios
                        reutilizables
                      </li>
                ...
                <div className="item der">
                  ...
                  <Box sx={{ ml: 5 }}>
                    <ul>
                      ...
                      <li>
                        Diseño, creación y alojamiento de la base de datos
                      </li>
          ...
          <div className="contenido-seccion">
            ...
            <div className="galeria">
              <div className="proyecto">
                <img
                  src="/images/Animazing1.PNG"
                  alt=""
                  style={{ width: "330px", height: "250px" }}
                />
                <div className="overlay">
                  <a
                    href="https://animazing-vaweei.netlify.app"
                    target="_blank"
                  >
                    <h3>Animazing</h3>
                    <br />
              ...
              {/* <div className="proyecto">
                ...
                <div className="overlay">
                  <a href="https://eltiobarbershop.com" target="_blank">
                    ...
                    <br />
                    <p>
                      Aplicación web para la franquicia de "El tío Barbershop
                      CDMX"
                    </p>
                  </a>
                </div>
              ...
              <div className="proyecto">
                ...
                <div className="overlay">
                  <a href="https://www.garmon.com.mx" target="_blank">
                    ...
                    <br />
                    <p>
                      LandingPage interacvtiva y dinámica para la empresa
                      Garmon-Solutions
                    </p>
                  </a>
                </div>
              ...
              <div className="proyecto">
                ...
                <div className="overlay">
                  <a
                    href="https://zam-ecommerce-demo.netlify.app"
                    target="_blank"
                  >
                    <h3>ECOMMERSE</h3>
                    <br />
                    <p>
                      Aplicación web real con administración, pagos y
                      seguimientos integrados
                    </p>
                  </a>
                </div>
              </div>
              ...
              <div className="proyecto">
                ...
                <div className="overlay">
                  <a href="https://chatzam.netlify.app" target="_blank">
                    ...
                    <br />
                    <p>
                      PWA realizada para crear un chat grupal de personajes
                      ficticios
                    </p>
                  </a>
                </div>
